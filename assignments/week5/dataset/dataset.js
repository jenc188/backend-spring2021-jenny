...
if (fs.existsSync("dataset.json")) {
    ...
    //initiate objectArray which will hold objects. Each object is a key-value pair of dataHeading: row entry. ObjectArray holds the data objects *relevant to the questions we are trying to answer* which is why we ignored (ignoredIndexes) certain fields.
